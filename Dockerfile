...
ENV PARAMS="--bandwidth P --share 50 --limits.transittunnels 256 --socksproxy.outproxy gateway.docker.internal --socksproxy.outproxyport 6666 --bob.enabled true --bob.address 0.0.0.0 --bob.port 2827 --upnp.enabled true --http.address 0.0.0.0 --http.strictheaders false --httpproxy.address 0.0.0.0 --socksproxy.address 0.0.0.0 --sam.enabled true --sam.address 0.0.0.0 --"
